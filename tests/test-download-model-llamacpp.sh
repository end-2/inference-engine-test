...
cp "$ROOT/scripts/download-model-llamacpp.sh" "$sandbox/scripts/"
...
cat > "$sandbox/config/models/qwen2.5-0.5b-gguf-llamacpp.env" <<EOF_CONFIG
...
script="$sandbox/scripts/download-model-llamacpp.sh"
