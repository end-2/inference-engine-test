...
from llamacpp.base.engine import LlamaEngine
from llamacpp.base.server import Settings, create_app as create_base_app, create_parser


def create_app(settings=None, engine_factory=LlamaEngine):
    return create_instrumented_app(create_base_app, settings, engine_factory, "llama")
