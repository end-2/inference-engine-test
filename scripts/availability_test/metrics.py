...
queries = {
    ...
    "pod_ready": 'kube_pod_status_ready{namespace="availability-test"}',
    "pod_info": 'kube_pod_info{namespace="availability-test"}',
    "pod_phase": 'kube_pod_status_phase{namespace="availability-test"}',
    "pod_restarts": 'kube_pod_container_status_restarts_total{namespace="availability-test"}',
    "deployment_available": 'kube_deployment_status_replicas_available{namespace="availability-test"}',
    "ready_endpoints": 'availability:service_ready_endpoints{namespace="availability-test"}',
    "unready_endpoints": 'availability:service_unready_endpoints{namespace="availability-test"}',
    "endpoints": 'kube_endpointslice_endpoints{namespace="availability-test"}',
    "up": "up",
